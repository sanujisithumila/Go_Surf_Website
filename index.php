...
<body>
    ...
    <section class="testimonials">
        ...
        <div class="row">
            <div class="testimonial-col">
                <img src="./assets/surf_img/user1.jpg">
                <div>
            ...
            <div class="testimonial-col">
                <img src="./assets/surf_img/user2.jpg">
                <div>
                    <p>Wow! What an Experience. Got many memories.</p>
                    <h3>David Byer</h3>
                    <i class="fa fa-star"></i>
        ...
        <div class="row">
            <div class="testimonial-col">
                <img src="./assets/surf_img/user3.jpg">
                <div>
                    <p>Wow! What an Experience. Got many memories.</p>
                    <h3>John Baker</h3>
                    <i class="fa fa-star"></i>
            ...
            <div class="testimonial-col">
                <img src="./assets/surf_img/user4.jfif">
                <div>
                    <p>Wow! What an Experience. Got many memories.</p>
                    <h3>Maya Angelou</h3>
                    <i class="fa fa-star"></i>
    ...
    <div class="star box">
        ...
        <form action="./controller/addReview.php" method="POST">
            <input type="hidden" name="session-id" value="<?=$_SESSION['user_id']?>">
            ...
            <textarea id="review" name="review" rows="2" cols="45" placeholder="Comment something" required></textarea>
            <br>
	...
	<!-- <div class="review review-c">
		<form action="./controller/addReview.php" method="POST">
            <input type="hidden" name="session-id" value="<?=$_SESSION['user_id']?>">
            Name: <input type="text" name="name"><br>
            Email : <input type="email" name="email"><br>
            <p><label for="review">Tell us Your Exeperience</label></p>
                <textarea id="review" name="review" rows="2" cols="45" placeholder="Comment something" required></textarea>
                <br>
            <button type="submit">Submit</button>
            <br>
